...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const newPassInput = document.getElementById('new_password') as HTMLInputElement | null;
    const newPassConfInput = document.getElementById('new_password_confirm') as HTMLInputElement | null;
    const matchIcon = document.getElementById('prof-match-icon') as HTMLElement | null;
