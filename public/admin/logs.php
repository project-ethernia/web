        ...
        <header class="admin-header glass-panel">
            ...
            <div class="header-actions">
                <div class="stat-pill glass-panel">
                    <span>Összesen: <strong class="text-white"><?= (int)$totalLogs; ?></strong> bejegyzés</span>
                </div>
            </div>
        </header>

        <section class="admin-content glass-panel filter-section">
        ...
        <section class="admin-content glass-panel">
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if (empty($logs)): ?>
                            <tr><td colspan="5" style="text-align: center; padding: 2rem;">Nincs találat a naplóban.</td></tr>
                        <?php else: ?>
                            <?php foreach ($logs as $log): ?>
                                ...
                                if (strpos($lower, 'sikeres') !== false) { $pillClass = 'badge-success'; $pillText = 'LOGIN'; }
                                ...
                                <tr class="log-row" data-context='<?= h($log['context'] ?: '{}'); ?>' data-ua="<?= h($log['user_agent'] ?: 'Nincs adat'); ?>">
                                    ...
                                    <td class="cell-admin">
                                        <strong><?= h($log['username'] ?: 'Ismeretlen'); ?></strong>
                                    </td>
