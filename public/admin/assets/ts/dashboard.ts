...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (greetingElement) {
        ...
        if (hour >= 5 && hour < 10) greeting = "Jó reggelt! Sikeres napot kívánunk.";
        else if (hour >= 10 && hour < 18) greeting = "Jó napot! Készen állsz a feladatokra?";
        else if (hour >= 18 && hour < 22) greeting = "Jó estét! Reméljük, produktív napod volt.";
        else greeting = "Jó éjszakát! A rendszer éberen figyel.";
