...
// MÁGIA: Egy izolált () => {} blokkba tesszük a kódot. 
// Így a változók nem kerülnek ki a globális térbe, és SOSEM lesz "redeclare" hiba!
(function () {
            ...
            switch (_d.label) {
                ...
                case 4:
                    ...
                    if (chatArea && newChatArea) {
                        ...
                        alertBox = doc.querySelector('.chat-closed-alert');
                        if (alertBox)
                            (_b = chatArea.parentNode) === null || _b === void 0 ? void 0 : _b.replaceChild(alertBox, chatArea);
                    }
                    else if (!chatArea && newChatArea) {
                        alertBox = document.querySelector('.chat-closed-alert');
                        if (alertBox)
                            (_c = alertBox.parentNode) === null || _c === void 0 ? void 0 : _c.replaceChild(newChatArea, alertBox);
                    }
                    return [3 /*break*/, 6];
                case 5:
    ...
    // Csak azt engedjük ki a globális térbe (a gomboknak), amire tényleg szükség van!
