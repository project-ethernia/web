...
<footer class="site-footer">
    <div class="footer-inner">
        <div class="footer-brand">
            <h3 class="footer-logo">ETHERNIA</h3>
            <p>Nem hivatalos Minecraft rajongói oldal. A tartalom nem áll kapcsolatban a Mojang Studios-szal.</p>
        </div>
        ...
        <div class="footer-meta">
            <p>&copy; <span id="year"></span> ETHERNIA.<br>Minden jog fenntartva.</p>
        </div>
    </div>
</footer>
